...
#define _GET_TIME_1_ clock_gettime(0, &ts0);
#define _PUT_TIME_1_ clock_gettime(0, &ts1);printf("total time=%ld ns\n",(ts1.tv_sec-ts0.tv_sec)*1000000000+(ts1.tv_nsec-ts0.tv_nsec));
#else
#define _GET_TIME_1_
#define _PUT_TIME_1_
#endif
...
#define _GET_TIME_21_ clock_gettime(0, &ts2);
#define _GET_TIME_22_ clock_gettime(0, &ts3);
...
#define _GET_TIME_31_ clock_gettime(0, &ts4);
#define _GET_TIME_32_ clock_gettime(0, &ts5);
...
#define _GET_TIME_41_ clock_gettime(0, &ts6);
#define _GET_TIME_42_ clock_gettime(0, &ts7);
...
#define _GET_TIME_51_ clock_gettime(0, &ts8);
#define _GET_TIME_52_ clock_gettime(0, &ts9);
...
#define _GET_TIME_61_ clock_gettime(0, &ts10);
#define _GET_TIME_62_ clock_gettime(0, &ts11);
...
#define _GET_TIME_71_ clock_gettime(0, &ts12);
#define _GET_TIME_72_ clock_gettime(0, &ts13);
...
#define _GET_TIME_81_ clock_gettime(0, &ts14);
#define _GET_TIME_82_ clock_gettime(0, &ts15);
...
#define _GET_TIME_91_ clock_gettime(0, &ts16);
#define _GET_TIME_92_ clock_gettime(0, &ts17);
...
int main(void){
    ...
    unsigned char V[(width*height*2)+width*height/4];
    unsigned char Yout[width*height];
    unsigned char Uout[width*height];
    unsigned char Vout[(width*height*2)+width*height/4];
    if( bitdepth==8 ){
